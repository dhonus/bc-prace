<template>
    ...
    <div class="home">
        ...
        <div class="input_wrapper" @keyup.ctrl.enter.exact="submitWithKey"
             @keyup.shift.enter.exact="submitWithKeySteps">
            <div class="predicates bubble">
                <div v-for="key in count" :key="key">
                    <Transition>
                        <input @focus="focusOnMe(key)" :rel="'predicate'+key" :ref="'predicate'+key" type="text"
                               v-model="values['dynamic-field-'+key]" :placeholder="key+'. premisa'"
                               :id="'predicate'+key" class="input-print" @input="handleTyping">
                    </Transition>
                </div>
                <div class="controls" style="justify-content: right; display: flex;">
                    ...
                    <button ref="buttonFour" class="button_plus" @click="removeP" title="Odebrat poslední premisu">-
                    </button>
                </div>
            ...
            <div class="left_section bubble">
                ...
                <div class="guide">
                    ...
                    <p>Následuje tabulka <b>podporovaných symbolů</b> a jejich <b>povolených variant</b>. Tyto symboly
                        <br>mohou být libovolně kombinovány.</p>
                    <table>
                        <tr>
                            <td>Implikace</td>
                            <td>⊃</td>
